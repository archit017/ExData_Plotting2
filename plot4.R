...
plot <- qplot(year, Emissions, data=data, geom="path", main="Emissions From Coal Combustion-Related Sources", xlab="Year", ylab="Emissions")
ggsave(plot, file="plot4.png", width=6, height=5)
